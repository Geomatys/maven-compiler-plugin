...
public final class DependencyCoordinate {
     ...
     */
    org.apache.maven.api.DependencyCoordinate toCoordinate(Project project, Session session) {
    ...
    private Optional<String> findManagedVersion(List<org.apache.maven.api.DependencyCoordinate> managedDependencies) {
