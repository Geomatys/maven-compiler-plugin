...
/**
 * Key for declaring source files as a dependency.
 * This is needed, for example, when patching a module (usually for compiling the tests).
 * In such case, the main code is a dependency specified by this key.
 *
